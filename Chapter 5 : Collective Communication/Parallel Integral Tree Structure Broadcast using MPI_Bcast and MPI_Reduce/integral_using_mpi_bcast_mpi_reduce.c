/*
 * integral_using_mpi_bcast_mpi_reduce.c
 *
 *  Created on: 17-Nov-2020
 *      Author	:	Prateek
 *      Pg		:	97
 *      Desc	:	Parallel Trapezoidal Rule.  Uses 3 calls to MPI_Bcast to
...
int main(int argc, char **argv) {
	...
	/* IMPORTANT : Add up the integrals calculated by each process */
